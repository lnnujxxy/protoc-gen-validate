# protoc-gen-star (PG*) [![Build Status](https://travis-ci.org/lnnujxxy/protoc-gen-star.svg?branch=master)](https://travis-ci.org/lnnujxxy/protoc-gen-star) [![GoDoc](https://godoc.org/github.com/lnnujxxy/protoc-gen-star?status.svg)](https://godoc.org/github.com/lnnujxxy/protoc-gen-star)
...
import "github.com/lnnujxxy/protoc-gen-star"
...
PG* currently implements the [pgsgo](https://godoc.org/github.com/lnnujxxy/protoc-gen-star/lang/go/) subpackage to provide these utilities to plugins targeting the Go language. Future subpackages are planned to support a variety of languages.
...
```sh
go get -u github.com/lnnujxxy/protoc-gen-star
cd $GOPATH/src/github.com/lnnujxxy/protoc-gen-star
make vendor
```
...
[pge]: https://github.com/lnnujxxy/protoc-gen-star/tree/master/testdata/protoc-gen-example
[travis]: https://travis-ci.com/lnnujxxy/protoc-gen-star
[travis.yml]: https://github.com/lnnujxxy/protoc-gen-star/tree/master/.travis.yml
[module]: https://github.com/lnnujxxy/protoc-gen-star/blob/master/module.go
[pb]: https://developers.google.com/protocol-buffers/
[context]: https://github.com/lnnujxxy/protoc-gen-star/tree/master/build_context.go
[visitor]: https://github.com/lnnujxxy/protoc-gen-star/tree/master/node.go
[params]: https://github.com/lnnujxxy/protoc-gen-star/tree/master/parameters.go
[make]: https://github.com/lnnujxxy/protoc-gen-star/blob/master/Makefile
